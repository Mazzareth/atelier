...
<head>
    ...
    <style>
        ...
        [data-theme="dronification"] { --bg-color: #06040f; --bg-panel: #0e0a1e; --accent-color: #b44dff; --accent-color-rgb: 180, 77, 255; --accent-dim: rgba(180, 77, 255, 0.16); --text-main: #f0e8ff; --text-muted: #9978cc; --border-color: #2e1a52; --stripe-bg: repeating-linear-gradient(120deg, #07030e 0 14px, #120926 14px 26px, #b44dff 26px 30px, #7b00e0 30px 34px, #07030e 34px 48px); --stripe-height: 7px; --stripe-anim: stripe-shift; --particle-color: 180, 77, 255; --radius-base: 2px; --radius-card: 6px; --radius-btn: 4px; --font-display: "Helvetica Neue", "Arial Narrow", sans-serif; --font-weight-heading: 900; --letter-spacing: 0.22em; --shadow-card: 0 24px 56px rgba(0, 0, 0, 0.82); --shadow-glow: 0 0 28px rgba(180, 77, 255, 0.38); --noise-opacity: 0.1; --texture-url: repeating-linear-gradient(90deg, rgba(180,77,255,0.04) 0 1px, transparent 1px 20px), repeating-linear-gradient(0deg, rgba(180,77,255,0.04) 0 1px, transparent 1px 20px), radial-gradient(ellipse at 50% 0%, rgba(180,77,255,0.12), transparent 60%); --anim-speed: 0.64; --anim-float-style: sink; --panel-bg: linear-gradient(180deg, rgba(14,10,30,0.98), rgba(6,4,15,0.99)); --glass-opacity: 0.01; }
        ...
        [data-theme="dronification"] .drone-helix { display: block; }
        [data-theme="dronification"] .drone-sigil { display: block; }
